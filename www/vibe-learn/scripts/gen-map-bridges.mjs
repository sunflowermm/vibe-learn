...
const MANUAL = {
  ...
  'git-workspace': ['vh-git', 'vh-clone', 'vh-commit', 'vh-diff', 'vh-frame-git'],
  'git-forges': ['vh-pull-request', 'vh-git', 'vh-push', 'vh-pull'],
  ...
  'api-frontend': ['vh-api', 'vh-http', 'vh-json', 'vh-cors', 'vh-route'],
  ...
  'routing-nat': ['vh-dns'],
  'http-web': ['vh-http', 'vh-https', 'vh-api', 'vh-url'],
  ...
  'xrk-http-www': ['vh-http', 'vh-api', 'vh-frontend', 'vh-route'],
  'xrk-subserver': ['vh-backend', 'vh-api', 'vh-route'],
  ...
  'craft-ci': ['vh-ci', 'vh-cd', 'vh-smoke-test'],
