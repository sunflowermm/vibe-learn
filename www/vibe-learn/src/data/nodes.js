...
export const knowledgeNodes = [
  ...
  },
  {
    ...
    next: ['fw-react', 'fw-angular', 'fw-nextjs', 'xrk-http-www'],
  ...
  },
  {
    ...
    prereqs: ['lang-library-framework', 'lang-javascript', 'lang-html-css'],
    next: ['fw-nextjs', 'fw-vue', 'xrk-http-www'],
  ...
  },
  {
    ...
    next: ['fw-vue', 'fw-react', 'xrk-http-www'],
  ...
  },
  {
    ...
    next: ['fw-express-nest', 'xrk-http-www'],
  ...
  },
  {
    ...
    prereqs: ['lang-landscape'],
    next: ['fw-vue', 'fw-react', 'lang-javascript', 'xrk-http-www'],
...
export const knowledgeEdges = [
  ...
  { id: 'e-vue-www', source: 'fw-vue', target: 'xrk-http-www', sourceHandle: 'right', targetHandle: 'left', label: '构建后挂 www', branch: 'bridge', animated: true },
  { id: 'e-react-www', source: 'fw-react', target: 'xrk-http-www', sourceHandle: 'right', targetHandle: 'left', label: '构建/反代挂 www', branch: 'bridge', animated: true },
  { id: 'e-angular-www', source: 'fw-angular', target: 'xrk-http-www', sourceHandle: 'right', targetHandle: 'bottom', label: '同样挂 www', branch: 'bridge' },
  { id: 'e-next-www', source: 'fw-nextjs', target: 'xrk-http-www', sourceHandle: 'right', targetHandle: 'top', label: '静态或反代', branch: 'bridge', animated: true },
  { id: 'e-html-www', source: 'lang-html-css', target: 'xrk-http-www', sourceHandle: 'right', targetHandle: 'left', label: '产物语言形态', branch: 'bridge' },
  { id: 'e-js-www', source: 'lang-javascript', target: 'xrk-http-www', sourceHandle: 'right', targetHandle: 'top', label: '浏览器侧语言', branch: 'bridge' },
