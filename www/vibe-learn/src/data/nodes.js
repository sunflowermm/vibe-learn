...
export const knowledgeNodes = [
  ...
  },
  {
    ...
    parentId: CH_XRK,
    label: 'LLM Factory',
    subtitle: '多客户端工厂 · ASR/TTS',
    tag: '04 工厂',
    role: 'src/factory + CommonConfig；工作流从此取模型。',
  ...
  },
  {
    ...
    parentId: CH_XRK,
    label: '对话管线',
    subtitle: '三层消息 · merge · Workspace',
    tag: '04 管线',
    role: 'assembleChatLlmMessages；mergeWorkflows；agent-context 真源。',
  ...
  },
  {
    ...
    parentId: CH_XRK,
    label: '办事助手',
    subtitle: 'agents/ · ai-workspace · 注入',
    tag: '04 Agent',
    role: '群聊/控制台对话 Agent；种子与工作区；四层 AGENTS 分工。',
