...
import dsaRecurse from './lessons/dsa-recurse.js';
import dsaTwoPointers from './lessons/dsa-two-pointers.js';
import dsaUnionFind from './lessons/dsa-union-find.js';
import dsaString from './lessons/dsa-string.js';
import dsaBitwise from './lessons/dsa-bitwise.js';
import dsaDp from './lessons/dsa-dp.js';
import dsaMl from './lessons/dsa-ml.js';
...
export const knowledgeNodes = [
  ...
  },
  {
    ...
    next: ['fw-nextjs', 'fw-spring', 'api-frontend', 'lang-to-runtime'],
  ...
  },
  {
    ...
    prereqs: ['computer-system'],
    next: ['http-web', 'xrk-http-www', 'xrk-overview'],
    position: LAYOUT.topics['api-frontend'],
    markdown: apiFrontend,
    chapterOut: ['xrk-overview', 'xrk-http-www'],
  },
  {
    id: 'protocol-stack',
    kind: 'topic',
  ...
  },
  {
    ...
    parentId: CH_CODE,
    label: '值与类型',
    subtitle: 'typeof · === · Array.isArray',
    tag: '01.5 语法',
    role: '动态类型；默认 ===；优先 const。',
  ...
  },
  {
    ...
    next: ['dsa-hash', 'dsa-recurse', 'dsa-two-pointers'],
  ...
  },
  {
    ...
    role: '终止+缩小+合并；回溯决策树。',
    prereqs: ['dsa-linear'],
    next: ['dsa-sort', 'dsa-two-pointers'],
    position: LAYOUT.topics['dsa-recurse'],
    markdown: dsaRecurse,
  },
  {
    id: 'dsa-two-pointers',
    ...
    role: '把暴力压到线性扫描。',
    prereqs: ['dsa-linear'],
    next: ['dsa-string', 'dsa-hot'],
    position: LAYOUT.topics['dsa-two-pointers'],
    markdown: dsaTwoPointers,
  },
  {
    id: 'dsa-union-find',
    kind: 'topic',
    ...
    subtitle: '动态连通',
    tag: '番外·DSA',
    role: 'find/union；路径压缩。',
    prereqs: ['dsa-graph'],
    next: ['dsa-hot'],
    position: LAYOUT.topics['dsa-union-find'],
    markdown: dsaUnionFind,
  },
  {
    id: 'dsa-string',
    kind: 'topic',
    ...
    tag: '番外·DSA',
    role: '异位词与子串模板。',
    prereqs: ['dsa-two-pointers'],
    next: ['dsa-bitwise'],
    position: LAYOUT.topics['dsa-string'],
    markdown: dsaString,
  },
  {
    id: 'dsa-bitwise',
    ...
    prereqs: ['dsa-string'],
    next: ['dsa-dp'],
    position: LAYOUT.topics['dsa-bitwise'],
    markdown: dsaBitwise,
  },
  {
    id: 'dsa-dp',
  ...
  },
  {
    ...
    subtitle: '梯度下降 · 计算图',
    tag: '番外·DSA',
    role: '工程师级优化直觉；不重复第五章。',
    prereqs: ['dsa-dp'],
    next: ['dsa-hot'],
    position: LAYOUT.topics['dsa-ml'],
    markdown: dsaMl,
  },
  {
    id: 'dsa-hot',
...
export const knowledgeEdges = [
  ...
  { id: 'e-api-www', source: 'api-frontend', target: 'xrk-http-www', sourceHandle: 'bottom', targetHandle: 'top', label: 'http/www 落地', branch: 'bridge', animated: true },
  { id: 'e-vue-www', source: 'fw-vue', target: 'xrk-http-www', sourceHandle: 'bottom', targetHandle: 'left', label: 'www 实例', branch: 'bridge', animated: true },
  { id: 'e-vue-api', source: 'fw-vue', target: 'api-frontend', sourceHandle: 'right', targetHandle: 'top', label: '前端调 API', branch: 'bridge' },
  { id: 'e-react-www', source: 'fw-react', target: 'xrk-http-www', sourceHandle: 'bottom', targetHandle: 'left', label: '同 www 挂载', branch: 'bridge' },
  { id: 'e-nest-api', source: 'fw-express-nest', target: 'api-frontend', sourceHandle: 'right', targetHandle: 'left', label: '后端框架对照', branch: 'bridge' },
  { id: 'e-nest-tr', source: 'fw-express-nest', target: 'lang-to-runtime', sourceHandle: 'bottom', targetHandle: 'top', label: '对照主服契约', branch: 'bridge' },
  { id: 'e-spring-sub', source: 'fw-spring', target: 'xrk-subserver', sourceHandle: 'right', targetHandle: 'left', label: 'JVM 子服族', branch: 'bridge' },
  ...
  { id: 'e-edge-clash', source: 'net-edge-practice', target: 'clash', sourceHandle: 'bottom', targetHandle: 'top', label: '客户端选路', branch: 'side', animated: true },
  { id: 'e-proxy-clash', source: 'reverse-proxy', target: 'clash', sourceHandle: 'bottom', targetHandle: 'left', label: '正向侧对照', branch: 'side' },
  { id: 'e-dns-clash', source: 'dns-https', target: 'clash', sourceHandle: 'bottom', targetHandle: 'top', label: '解析/出口对照', branch: 'side' },
  ...
  { id: 'e-xrk-fac-mcp', source: 'xrk-factory-llm', target: 'xrk-mcp-ops', sourceHandle: 'right', targetHandle: 'left', label: '模型↔工具环', branch: 'c4' },
  { id: 'e-xrk-auth-mcp', source: 'xrk-http-auth', target: 'xrk-mcp-ops', sourceHandle: 'bottom', targetHandle: 'top', label: '门禁对齐', branch: 'c4' },
  { id: 'e-clash-deploy', source: 'clash', target: 'xrk-deploy-env', sourceHandle: 'right', targetHandle: 'left', label: '出口进清单', branch: 'bridge' },
  { id: 'e-rev-xrk', source: 'reverse-proxy', target: 'xrk-http-www', sourceHandle: 'right', targetHandle: 'top', label: '反代对门面', branch: 'bridge' },
  { id: 'e-labplug-http', source: 'xrk-lab-plugin', target: 'xrk-lab-http', sourceHandle: 'right', targetHandle: 'left', label: '再练 HTTP', branch: 'c4' },
  ...
  { id: 'e-ai-ft', source: 'ai-adaptation', target: 'ai-finetune', sourceHandle: 'bottom', targetHandle: 'top', label: '改参手法', branch: 'c5' },
  { id: 'e-ai-chat', source: 'ai-finetune', target: 'ai-chat-era', sourceHandle: 'left', targetHandle: 'right', label: '产品化', branch: 'c5' },
  { id: 'e-ai-cc', source: 'ai-chat-era', target: 'ai-openai-protocol', sourceHandle: 'left', targetHandle: 'right', label: '可编程会话', branch: 'c5' },
  { id: 'e-ai-embed', source: 'ai-openai-protocol', target: 'ai-embedding', sourceHandle: 'left', targetHandle: 'right', label: '先向量化', branch: 'c5', animated: true },
  { id: 'e-ai-rag', source: 'ai-embedding', target: 'ai-rag', sourceHandle: 'left', targetHandle: 'right', label: '外挂知识', branch: 'c5', animated: true },
  { id: 'e-ai-chunk', source: 'ai-rag', target: 'ai-chunking', sourceHandle: 'left', targetHandle: 'right', label: '入库切段', branch: 'c5', animated: true },
  { id: 'e-ai-hybrid', source: 'ai-chunking', target: 'ai-hybrid-search', sourceHandle: 'left', targetHandle: 'right', label: '召回组合', branch: 'c5', animated: true },
  { id: 'e-ai-rerank', source: 'ai-hybrid-search', target: 'ai-rerank', sourceHandle: 'left', targetHandle: 'right', label: '精排进窗', branch: 'c5', animated: true },
  { id: 'e-ai-vstore', source: 'ai-chunking', target: 'ai-vector-store', sourceHandle: 'bottom', targetHandle: 'top', label: '向量索引', branch: 'c5' },
  { id: 'e-ai-rageval', source: 'ai-rerank', target: 'ai-rag-eval', sourceHandle: 'bottom', targetHandle: 'top', label: '用数据说话', branch: 'c5', animated: true },
  { id: 'e-ai-eval-arag', source: 'ai-rag-eval', target: 'ai-agentic-rag', sourceHandle: 'bottom', targetHandle: 'top', label: '评测后再多轮', branch: 'c5' },
  { id: 'e-ai-tools', source: 'ai-rag', target: 'ai-tool-calling', sourceHandle: 'bottom', targetHandle: 'top', label: '能提行动', branch: 'c5', animated: true },
  ...
  { id: 'e-ai-agent', source: 'ai-protocol-forks', target: 'ai-agent-birth', sourceHandle: 'right', targetHandle: 'left', label: '智能体循环', branch: 'c5', animated: true },
  { id: 'e-ai-mem', source: 'ai-agent-birth', target: 'ai-agent-memory', sourceHandle: 'right', targetHandle: 'left', label: '状态分层', branch: 'c5', animated: true },
  { id: 'e-ai-plan', source: 'ai-agent-birth', target: 'ai-agent-planning', sourceHandle: 'right', targetHandle: 'left', label: '控制策略', branch: 'c5', animated: true },
  ...
  { id: 'e-ai-graph', source: 'ai-agent-birth', target: 'ai-agent-graph', sourceHandle: 'bottom', targetHandle: 'top', label: '图编排', branch: 'c5', animated: true },
  { id: 'e-ai-arag', source: 'ai-agent-graph', target: 'ai-agentic-rag', sourceHandle: 'left', targetHandle: 'right', label: '多轮检索', branch: 'c5' },
  { id: 'e-ai-ragshift', source: 'ai-agentic-rag', target: 'ai-rag-shift', sourceHandle: 'left', targetHandle: 'right', label: '上下文工程', branch: 'c5' },
  { id: 'e-ai-rules', source: 'ai-rag-shift', target: 'ai-rules', sourceHandle: 'left', targetHandle: 'right', label: '硬约束', branch: 'c5' },
  { id: 'e-ai-skills', source: 'ai-rules', target: 'ai-skills', sourceHandle: 'left', targetHandle: 'right', label: '按需手册', branch: 'c5', animated: true },
  { id: 'e-ai-sub', source: 'ai-skills', target: 'ai-subagent', sourceHandle: 'left', targetHandle: 'right', label: '委派', branch: 'c5' },
  { id: 'e-ai-cli', source: 'ai-subagent', target: 'ai-cli', sourceHandle: 'left', targetHandle: 'right', label: '终端面', branch: 'c5' },
  { id: 'e-ai-agentsmd', source: 'ai-cli', target: 'ai-agents-md', sourceHandle: 'left', targetHandle: 'right', label: '项目交底', branch: 'c5', animated: true },
  ...
  { id: 'e-dsa-l-r', source: 'dsa-linear', target: 'dsa-recurse', sourceHandle: 'bottom', targetHandle: 'top', label: '递归', branch: 'side' },
  { id: 'e-dsa-l-tp', source: 'dsa-linear', target: 'dsa-two-pointers', sourceHandle: 'bottom', targetHandle: 'top', label: '双指针', branch: 'side' },
  { id: 'e-dsa-g-uf', source: 'dsa-graph', target: 'dsa-union-find', sourceHandle: 'bottom', targetHandle: 'top', label: '连通', branch: 'side' },
  { id: 'e-dsa-r-s', source: 'dsa-recurse', target: 'dsa-sort', sourceHandle: 'left', targetHandle: 'right', label: '分治排序', branch: 'side' },
  { id: 'e-dsa-tp-str', source: 'dsa-two-pointers', target: 'dsa-string', sourceHandle: 'bottom', targetHandle: 'top', label: '子串窗', branch: 'side' },
  { id: 'e-dsa-str-bit', source: 'dsa-string', target: 'dsa-bitwise', sourceHandle: 'right', targetHandle: 'left', label: '位技巧', branch: 'side' },
  { id: 'e-dsa-s-dp', source: 'dsa-sort', target: 'dsa-dp', sourceHandle: 'bottom', targetHandle: 'top', label: '最优子结构', branch: 'side' },
  { id: 'e-dsa-bit-dp', source: 'dsa-bitwise', target: 'dsa-dp', sourceHandle: 'right', targetHandle: 'left', label: '状压', branch: 'side' },
  { id: 'e-dsa-dp-ml', source: 'dsa-dp', target: 'dsa-ml', sourceHandle: 'bottom', targetHandle: 'top', label: '优化直觉', branch: 'side' },
  { id: 'e-dsa-dp-hot', source: 'dsa-dp', target: 'dsa-hot', sourceHandle: 'right', targetHandle: 'left', label: '题型串', branch: 'side', animated: true },
  { id: 'e-dsa-ml-hot', source: 'dsa-ml', target: 'dsa-hot', sourceHandle: 'right', targetHandle: 'left', label: '回题库', branch: 'side' },
