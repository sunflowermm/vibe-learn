...
export const knowledgeNodes = [
  ...
  },
  {
    ...
    tag: '04 工作流',
    role: '融会 HTTP/插件/配置/Factory；注入办事工作区；通往第五章。',
    prereqs: ['xrk-http-www', 'xrk-config', 'xrk-plugin-arch', 'xrk-factory-llm'],
    next: ['xrk-agent-workspace', 'xrk-mcp-ops', 'ai-what'],
...
export const knowledgeEdges = [
  ...
  { id: 'e-xrk-stream-agent', source: 'xrk-stream', target: 'xrk-agent-workspace', sourceHandle: 'bottom', targetHandle: 'top', label: '工作区注入', branch: 'c4', animated: true },
