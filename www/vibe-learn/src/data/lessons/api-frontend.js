...
## 导图2 · 前端 / HTTP / 路由 / CORS × API 分界

> 导图2 前端区与后端区在本课交汇：**谁发起、谁提供、路径怎么定**。  
> **本仓落点以第四章 HTTP/www 为准**；本课先建立分界与风格地图。

| 导图2 | Vibe 口语 | 本课专业落点 |
|-------|-----------|--------------|
| **前端** | 浏览器 UI | 常经 HTTP 调后端；静态页 ≠ API |
| **HTTP** | 运输语言 | REST 风格 API 的主载体 |
| **路由与端点** | URL 对应能力 | 方法+路径约定资源操作 |
| **JSON** | 常见报文身体 | 与 Content-Type 一起验收 |
| **CORS** | 跨源被拦 | 浏览器策略；服务端配置配合 |
