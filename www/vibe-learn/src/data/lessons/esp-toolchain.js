...
> **学会之后**：能指认一种工具链入口，并说出串口监视在排障中的位置。
...
## 本课分块
\`\`\`check
{"title":"ESP 工具链清单","items":[{"text":"工具链 / IDE 装好","hint":"按官方文档"},{"text":"串口驱动与权限","hint":"Windows 常见 COM"},{"text":"能烧录并看见日志","hint":"先点灯再联网"}]}
\`\`\`
