...
|------|----------|
| 边界 | Go 作可选子服；不替代主服 |
| 交付 | 能口述编译出二进制 vs Node 带运行时 |
| 对照 | Gin 等是框架，语言是 Go |
| 跟 Agent | 要 Go 能力时标明子服而非改 Runtime |
...
> Go 常编译成单文件；本仓作可选子服语言，不替代主服 Node。

| 导图2 | Vibe 口语 | 本课专业落点 |
|-------|-----------|--------------|
| **后端** | 服务端语言 | 本仓 goserver 等子服路径 |
| **构建** | 编译出二进制 | 分发常更轻；与 Node「带运行时」不同 |
| **部署上线** | 独立进程 | 经子服契约与主服协作 |
