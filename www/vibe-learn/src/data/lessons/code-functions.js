...
\`\`\`term
{"title":"函数跑通形态","prompt":"$ ","env":"练习目录（演示）","steps":[{"type":"in","text":"node -e \\"const add=(a,b)=>a+b; console.log(add(1,2))\\""},{"type":"out","text":"3"}]}
\`\`\`
...
**对象与数组** — 一次传递一包相关数据。
## 导图2 · JavaScript / 组件 × 函数

> 组件与模块最终常是函数组合。

| 导图2 | Vibe 口语 | 本课专业落点 |
|-------|-----------|--------------|
| **JavaScript** | 一等公民函数 | 回调与闭包常见 |
| **组件** | UI 组件背后 | 仍是函数/对象 |
