...
\`\`\`check
{"title":"协议分层通关","items":[{"id":"l1","text":"能区分 Chat Completions 兼容 vs 厂商原生扩展","hint":"L1"},{"id":"l2","text":"能说明 MCP 管工具插接，不管「谁是聊天 API」","hint":"L2"},{"id":"l3","text":"知道 A2A 等协作层非本仓主路径默认","hint":"L3"}]}
\`\`\`
