...
## 导图2 · Vibe Coding / Agent / Skill × 五拍主脊

> 上文已合入导图2 的定义与边界；下表把**口语钉回本站流程**。  
> **五拍、安全底线、路径 A/B 分叉以本课为准**；词条不能替代 Accept 前审 diff。

| 导图2 | Vibe 口语 | 本课专业落点 |
|-------|-----------|--------------|
| **Vibe Coding** | 对话驱动试想法 | 五拍委派；能跑 ≠ 可靠；严肃用途要审查与测试 |
| **AI Agent** | 多步工具施工 | 路径 A=Coding Agent 改仓库；路径 B 应用概念在第五章 |
| **Harness Engineering** | 指令+工具+模型 | 心智课认 harness；形态细节见黄页 |
| **Skill** | 长流程手册 | 交底进项目记忆课；勿只靠聊天 |
| **系统提示词** | 人设与硬约束 | 写进 Rules/AGENTS；密钥永不进仓 |
