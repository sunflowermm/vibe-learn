...
> **学会之后**：能按「系统 / 托管 / 脚本 / 标记」四层指出一门语言落点，并说清本仓主服与子服边界。

## 学会之后（验收）

| 能力 | 成功信号 |
|------|----------|
| 层次感 | 把 Go/Rust、Java/C#、JS/Python、HTML/CSS 各放进一层 |
| 语言 vs 框架 | Vue/Spring **不进**语言表；宿主语言能指出来 |
| 本仓坐标 | 主服 JS+Node；其它语言只在 \`subserver/<runtime>/\` |
| 阅读策略 | 先读与本仓相关的分课，再按需观光对照 |

## 与上一课的关系
\`\`\`steps
{"title":"语言版图怎么读","steps":[{"title":"先场景","body":"Web？系统？数据？嵌入式？"},{"title":"再运行时","body":"要 JVM / Node / 原生二进制吗？"},{"title":"再生态","body":"包管理、框架、招人与子服是否已有。"},{"title":"回 XRK","body":"主服钉 JS；其它语言走子服边界。"}]}
\`\`\`
...
## 分课导航（一门语言一块）
\`\`\`check
{"title":"选型前清单","items":[{"text":"宿主与运行时是否已定","hint":"如本仓 Node"},{"text":"团队存量技能","hint":"学习成本是真实成本"},{"text":"部署与运维路径","hint":"二进制 / 容器 / 托管"}]}
\`\`\`
...
> 版图是**观光对照**；动手仍回 01.5。导图2 各语言词条可按需点开。

| 导图2 | Vibe 口语 | 本课专业落点 |
|-------|-----------|--------------|
| **技术栈** | 多语言拼盘幻觉 | 本仓不是主服语言拼盘；版图≠都要学会 |
| **前端** | 浏览器侧语言 | HTML/CSS/JS；框架另挂 |
| **后端** | 服务侧语言 | 本仓主服 JS；其它见子服 |
| **JavaScript** | 本仓锚点 | 先钉 JS+Node，再观光其它 |
