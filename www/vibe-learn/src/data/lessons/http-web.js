...
| 本课 | 导图2 | 用途 |
|------|-------|------|
| 请求-响应 / 方法 / 状态码 | **HTTP** · **HTTPS** · **URL** | 读 401/404 先于调模型温度 |
| 重定向 / 缓存直觉 | **重定向** · **CDN**（下一课） | CDN 是副本靠近用户 |
| 调模型 API | HTTP + **JSON** · 认证相关词 | Chat API 仍是 HTTPS 应用层 |

跨导图补名词；\`curl\` 验收与本仓 Auth 仍按本课 / 第四章。
