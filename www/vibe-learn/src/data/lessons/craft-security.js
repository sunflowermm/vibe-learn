...
\`\`\`algo
{"kind":"secbase","title":"安全底线：密钥 · 注入 · 鉴权 · 审 diff","autoplay":true,"speed":800}
\`\`\`

\`\`\`check
{"title":"安全通关","items":[{"id":"secret","text":"密钥不进 Git / 公开聊天；泄漏先轮换","hint":"密钥"},{"id":"inject","text":"知 SQL/命令拼接风险；参数化优先","hint":"注入"},{"id":"authz","text":"认证≠授权；敏感接口服务端再判","hint":"鉴权"},{"id":"diff","text":"审 Agent diff：密钥、任意写、关校验","hint":"守门"}]}
\`\`\`
