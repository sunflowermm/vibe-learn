...
## 本课分块
\`\`\`quiz
{"title":"设备联网自测","questions":[{"q":"设备「连上 Wi-Fi」之后通常还缺什么？","choices":[{"t":"应用层协议与云/网关地址","ok":true,"why":"有链路不等于业务互通。"},{"t":"必须改用机械硬盘","ok":false,"why":"无关。"},{"t":"卸载 TCP","ok":false,"why":"仍常用 IP/TCP。"}]}]}
\`\`\`
