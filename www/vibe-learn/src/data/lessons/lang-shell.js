...
| 能力 | 成功信号 |
|------|----------|
| 身份 | Shell 是发令/脚本方言，不是本仓主语言 |
| 对照 | 与第一章终端课衔接；密钥不进脚本仓库 |
| 边界 | 胶水脚本 ≠ 业务插件 |
| 跟 Agent | 要脚本时写明 Bash 还是跨平台约束 |
...
## 3. 工具链
\`\`\`quiz
{"title":"shell 快测","questions":[{"q":"学一门语言时，最先要分清的两件基础事是？","choices":[{"t":"只背语法关键字","ok":false,"why":"语法重要，但交付模型更影响工程。"},{"t":"语言 vs 运行时 vs 常用框架","ok":true,"why":"三层混谈会面试翻车、选型也翻车。"},{"t":"必须先会操作系统内核","ok":false,"why":"有帮助，但不是本课第一刀。"}]}]}
\`\`\`
...
> Shell 是发令方言；导图2 终端词条互补。第一章已练手，本课钉语言身份。

| 导图2 | Vibe 口语 | 本课专业落点 |
|-------|-----------|--------------|
| **终端命令行** | 交互面 | Shell 脚本是文本程序，不是 GUI |
| **环境变量** | 进程继承 | 脚本里常见；密钥勿写进仓库 |
| **构建** | 胶水脚本 | CI/本地脚本常用；替代不了主服业务 |
