...
\`\`\`quiz
{"title":"工厂快测","questions":[{"q":"在 Core 里正确调用模型的方式是？","choices":[{"t":"经 AiWorkflow / 工厂 API 取客户端，配置选 Provider","ok":true,"why":"统一超时、代理、协议差异。"},{"t":"每个插件 new 一份厂商 SDK 并硬编码 Key 进源码","ok":false,"why":"密钥与分叉维护灾难。"},{"t":"模型只能跑在子服 Python，主服 Node 禁止调 LLM","ok":false,"why":"本仓 LLM 在主服工厂。"},{"t":"有了 Factory 就不必再走 HTTPS，明文出网即可","ok":false,"why":"出网仍要安全传输。"}]},{"q":"openai_compat_llm 更适合？","choices":[{"t":"第三方 OpenAI 形态网关","ok":true,"why":"builtin 留给官方协议客户端。"},{"t":"替代 Redis","ok":false,"why":"无关。"},{"t":"只用于前端 Vite","ok":false,"why":"服务端配置。"},{"t":"关闭所有 MCP","ok":false,"why":"正交。"}]},{"q":"工具轮用尽后，本仓 finalize 步骤是做什么？","choices":[{"t":"再发一轮无工具请求，用已有结果写正文","ok":true,"why":"tool-loop-finalize。"},{"t":"自动改仓库根 AGENTS.md","ok":false,"why":"无关。"},{"t":"重启 Redis","ok":false,"why":"无关。"},{"t":"关闭 MCP 挂载","ok":false,"why":"正交。"}]}]}
\`\`\`
