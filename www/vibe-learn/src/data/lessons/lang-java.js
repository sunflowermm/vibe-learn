...
| 能力 | 成功信号 |
|------|----------|
| 分层 | Java 语言 + JVM；Spring 是框架 |
| 本仓 | 能力在 jserver 一侧 |
| 纠错 | 拒绝「Spring 语言」 |
| 跟 Agent | Java 任务与主服 JS 插件分清仓库路径 |
...
> Java + JVM；Spring 是框架不是语言。本仓 Java 能力走 jserver 子服。

| 导图2 | Vibe 口语 | 本课专业落点 |
|-------|-----------|--------------|
| **后端** | JVM 生态 | 语言 Java；运行时常见 HotSpot JVM |
| **技术栈** | 常搭 Spring | 框架课 fw-spring；勿说「Spring 语言」 |
| **部署上线** | 子服进程 | 不进主服 Node 进程 |
