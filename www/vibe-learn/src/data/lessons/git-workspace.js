...
| 本课 | 导图2 | 钉死 |
|------|-------|------|
| 工作区 / 三区 | **Git** · **Clone** · **Commit** · **Diff** | clone 得到的是源码树，不是「装好的 Node」 |
| 远程更新 | **Pull** · **Push** · **Pull Request**（托管课） | PR 是协作流程，不是 git 内部对象名的全部 |
| 分支并行 | **分支** · **Worktree**（进阶） | 工作树 ≠ 随便复制文件夹 |

导图2 **Git 大区**可当名词字典；本课验收仍是：本机有干净工作区并能 \`pnpm install\`。
