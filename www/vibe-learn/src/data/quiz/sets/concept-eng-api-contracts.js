  ...
  questions: [
    ...
    },
    {
      ...
      choices: [
        ...
        {
          t: '一律返回 HTTP 200，把错误细节写在 HTML 注释里给人工阅读',
          ok: false,
          why: '反模式，自动化客户端无法依赖。',
        },
        {
          t: '错误时不返回任何 body，也不提供稳定可分支的业务错误码',
          ok: false,
          why: '难排查、难分支。',
        },
        {
          t: '把数据库密码放进错误信息，方便联调时直接复制复现',
          ok: false,
          why: '泄漏事故。',
        },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        {
          t: "分页只是为了 UI 动画好看，契约里不必写清排序与游标语义",
          ok: false,
          why: '资源保护才是核心。',
        },
        {
          t: "一次返回全部资源永远最优，超时与内存压力可以事后再谈",
          ok: false,
          why: '规模上来必炸。',
        },
        {
          t: "游标分页禁止用于公开 API，只能在内部批处理任务里使用",
          ok: false,
          why: '深分页常用游标。',
        },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        {
          t: '只用于静态 CSS 强缓存，与写操作重试无关',
          ok: false,
          why: '缓存用 Cache-Control/ETag，不是幂等键。',
        },
        {
          t: '幂等键等于 JWT 签名算法名称，写在 Authorization 里即可',
          ok: false,
          why: '概念不同。',
        },
        {
          t: '有了幂等键就可以明文传密码，不必再走 HTTPS',
          ok: false,
          why: '与机密性无关。',
        },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        {
          t: '永不告知调用方，直接改字段语义并静默上线生产',
          ok: false,
          why: '不专业。',
        },
        {
          t: '版本号只写在服务器主机名里即可，客户端完全不必感知',
          ok: false,
          why: '脆弱且难发现。',
        },
        {
          t: '禁止任何版本策略，允许字段每周随机改名与改类型',
          ok: false,
          why: '无法协作。',
        },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        {
          t: '工具应拥有生产库 root 且无审计，方便模型自由排障',
          ok: false,
          why: '危险。',
        },
        {
          t: '工具失败可以静默当成功，以免打断模型连贯输出',
          ok: false,
          why: '模型会据此编造。',
        },
        {
          t: '不必描述参数类型与必填项，模型会自己猜对 schema',
          ok: false,
          why: '更易胡调。',
        },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        {
          t: '浏览器会自动把旧字段名映射到新名，前端不必发版',
          ok: false,
          why: '不会。',
        },
        {
          t: '只要 HTTP 状态是 200，后端字段名就可以随意改且前端无感',
          ok: false,
          why: '200 不保证形状兼容。',
        },
        {
          t: 'DNS TTL 会缓冲字段重命名，旧客户端仍能读到旧字段名',
          ok: false,
          why: 'DNS 不管 JSON 字段。',
        },
      ],
