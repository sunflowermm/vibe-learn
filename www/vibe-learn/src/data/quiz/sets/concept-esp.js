  ...
  questions: [
    ...
    },
    {
      ...
      choices: [
        ...
        {
          t: '立刻格式化电脑系统盘，再重装驱动与主板 BIOS 碰运气',
          ok: false,
          why: '过激且与串口无关。',
        },
        {
          t: '把固件二进制直接 commit 进公开仓当日志留存，便于同事对照',
          ok: false,
          why: '既不排障，还可能含密钥与体积垃圾。',
        },
        {
          t: '关掉所有 USB 电源管理并永远禁用串口设备，避免干扰',
          ok: false,
          why: '禁用串口等于放弃调试通道。',
        },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        {
          t: '设备直连生产库 root 账号写表，完全跳过应用层鉴权与配额校验',
          ok: false,
          why: '扩大攻击面；边缘设备不应握库特权。',
        },
        {
          t: '明文 HTTP 且无鉴权先跑通后，就永久上线并且永不做加固',
          ok: false,
          why: '演示可临时，上线必须鉴权与加密。',
        },
        {
          t: '把云端私钥烧进每块开发板，并公开原理图附件方便量产维修',
          ok: false,
