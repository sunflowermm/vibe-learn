...
export default defineQuizSet({
  ...
  questions: [
    ...
    },
    {
      ...
      q: '管道 | 的正确直觉？',
      choices: [
        { t: '前命令 stdout → 后命令 stdin', ok: true, why: '如 ps aux | grep node。' },
        { t: '建立新的 TCP 连接', ok: false, why: '本地进程管道。' },
        { t: '两个命令完全并行且互不传数据', ok: false, why: '管道强调数据流。' },
        { t: '自动提权为 root', ok: false, why: '无关。' },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        { t: 'git df', ok: false, why: '否。' },
        { t: 'npm disk', ok: false, why: '否。' },
        { t: 'chmod -h', ok: false, why: '否。' },
      ],
      relatedNodes: ['linux-cli', 'workbench-troubleshoot'],
      tags: ['基础', '进阶'],
    },
    {
      ...
      choices: [
        ...
        { t: 'tar 只能压缩单个字母文件名', ok: false, why: '否。' },
        { t: 'unzip 是唯一能处理 .tar.gz 的工具', ok: false, why: 'zip≠tar.gz。' },
        { t: 'tar -czf 会自动 git push', ok: false, why: '否。' },
      ],
      relatedNodes: ['linux-cli'],
      tags: ['基础'],
    },
    {
      ...
      choices: [
        ...
        { t: 'sudo 等于关闭防火墙', ok: false, why: '否。' },
        { t: '普通用户永远不能读自己的家目录', ok: false, why: '可以。' },
      ],
      relatedNodes: ['linux-cli', 'craft-security'],
      tags: ['进阶'],
    },
    {
      ...
      choices: [
        ...
        { t: 'git log -u my.service', ok: false, why: 'Git 历史。' },
        { t: 'npm journal', ok: false, why: '否。' },
        { t: 'docker journalctl 等于删除镜像', ok: false, why: '否。' },
      ],
      relatedNodes: ['host-systemd', 'linux-cli'],
      tags: ['进阶'],
    },
