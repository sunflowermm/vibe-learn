  ...
  questions: [
    ...
    },
    {
      ...
      choices: [
        ...
        {
          t: '远程有人 push 了同名路径，本地未 pull 时 status 也会标成已修改',
          ok: false,
          why: 'status 看的是本地工作区相对本地提交；远程更新要 fetch/pull 才进视野。',
        },
        {
          t: '这是 Git 周期性「磁盘健康检查」，会随机改几个文件再标 modified',
          ok: false,
          why: 'Git 不会无故改工作区；看到修改应先 diff。',
        },
        {
          t: '说明 .git 已损坏，只能删库重 clone，没有先看 diff 的必要',
          ok: false,
          why: '先审 diff/换行/未保存窗口；重 clone 是最后手段。',
        },
      ],
