  ...
  questions: [
    ...
    },
    {
      ...
      choices: [
        ...
        { t: '一次写出完整电商网站', ok: false, why: '目标过大；第一程序只验证工具链。' },
        { t: '证明不需要任何工具链', ok: false, why: '仍需编辑器与运行时（如 Node）。' },
        { t: '复制成功就永远不必理解', ok: false, why: '能跑是开始；理解才能自己排障与改代码。' },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        { t: '立刻重装系统', ok: false, why: '多数是代码/路径问题；重装掩盖根因且成本高。' },
