...
export default defineQuizSet({
  ...
  questions: [
    ...
    },
    {
      ...
      choices: [
        {
          t: '改文件、看终端、看 diff 的工作台',
          ok: true,
          why: 'Agent 辅助也要你审 diff。',
        },
        {
          t: '编辑器会完全替代 Git、CI 与远程服务器',
          ok: false,
          why: '版本与部署仍靠 Git/CI/服务器，编辑器只是工作台。',
        },
        {
          t: '只能只读预览，不能保存或修改任何源码',
          ok: false,
          why: '核心能力就是编辑与保存源码。',
        },
        {
          t: '必须在编辑器里手写机器码才能运行现代项目',
          ok: false,
