  ...
  questions: [
    {
      ...
      choices: [
        ...
        { t: '只是本地打开一个 Word 文档', ok: false, why: '涉及网络请求。' },
        { t: '不需要任何服务器', ok: false, why: '通常有远端响应。' },
        { t: 'HTTPS 表示一定不安全', ok: false, why: 'S 表示加密传输。' },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        { t: '一种电源插头型号', ok: false, why: '硬件接口是另一回事。' },
        { t: '只能给人类阅读的说明书 PDF', ok: false, why: '机器调用。' },
        { t: '等于数据库本身', ok: false, why: 'API 常访问库，但不是库。' },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        { t: 'Git 只用来下载电影', ok: false, why: '否。' },
        { t: '有了云盘就不需要版本历史', ok: false, why: '云盘≠提交级历史与分支。' },
        { t: 'Git 会自动写业务逻辑', ok: false, why: '否。' },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        { t: 'commit 等于立刻上线给全世界用户', ok: false, why: '还要 push/部署。' },
        { t: 'commit 会删除所有历史', ok: false, why: '恰恰保留历史。' },
        { t: '只能每天 commit 一次', ok: false, why: '按逻辑小步提交更好。' },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        { t: '写进仓库更方便所以推荐', ok: false, why: '泄漏风险。' },
        { t: '私有仓绝对不会泄漏', ok: false, why: '仍可能。' },
        { t: '环境变量只能存图片', ok: false, why: '一般是字符串。' },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        { t: '一定是某台国外服务器', ok: false, why: '回环地址。' },
        { t: '等于断开网线', ok: false, why: '否。' },
        { t: '只能用于打印', ok: false, why: '否。' },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        { t: '显示器刷新率', ok: false, why: '否。' },
        { t: 'Git 分支名', ok: false, why: '否。' },
        { t: '只能是 80，其它非法', ok: false, why: '可有很多端口。' },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        { t: '一种数据库引擎品牌', ok: false, why: '格式≠引擎。' },
        { t: '只能存视频', ok: false, why: '文本结构。' },
        { t: '浏览器看不懂 JSON', ok: false, why: '前端天天用。' },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        { t: '替代 Git', ok: false, why: '职责不同。' },
        { t: '只能在手机上运行', ok: false, why: '服务器/开发机常用。' },
      ],
    ...
    },
    {
      ...
      choices: [
        ...
        { t: '直接微调大模型权重', ok: false, why: '跳级。' },
        { t: '删除所有报错信息来源', ok: false, why: '否。' },
        { t: '把生产密钥发到公开群', ok: false, why: '事故。' },
      ],
